        ...
        <div
            ...
            <div className="py-4">
                ...
                <form>
                    {/* <!-- Cover Image --> */}
                    <div
                        className="w-full rounded-lg bg-[url('https://images.unsplash.com/photo-1449844908441-8829872d2607?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw2fHxob21lfGVufDB8MHx8fDE3MTA0MDE1NDZ8MA&ixlib=rb-4.0.3&q=80&w=1080')] bg-cover bg-center bg-no-repeat items-center">
                        {/* <!-- Profile Image --> */}
                        <div
                        ...
                        <div className="flex justify-end">                           
                            ...
                            <div
                                className="bg-white flex items-center gap-2 rounded-tl-md px-2 text-center font-semibold">
                    ...
                    <div className="flex flex-col lg:flex-row gap-2 justify-center w-full">
                        <div className="w-full  mb-4 mt-6">
                            ...
                            <input type="text"
                                    className="mt-2 px-4 py-2 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                    ...
                    <div className="flex flex-col lg:flex-row  gap-2 justify-center w-full">
                        <div className="w-full">
                            ...
                            <select
                                    className="w-full text-grey border-2 rounded-lg px-4 py-3 pl-2 pr-2 dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800">
                        ...
                        <div className="w-full">
                            ...
                            <input type="date"
                                    className="text-grey px-4 py-2 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"/>
                        </div>
                    </div>
                    <div className="w-full flex justify-end  mt-4 text-white text-lg font-semibold">
                        <button type="submit" className="rounded-lg w-1/3 p-4 bg-blue-500">Submit</button>
                    </div>
                </form>
            </div>
        </div>
